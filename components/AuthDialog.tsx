    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          />
          {/* 外层负责滚动与居中：内容比视口高时（如手机弹出键盘）也能完整滚动查看 */}
          <div
            onClick={onClose}
            className="fixed inset-0 z-[90] flex items-start sm:items-center justify-center overflow-y-auto overscroll-contain p-4 py-8"
          >
            <motion.div
            ...
            >
              <div className="glass rounded-3xl p-5 sm:p-6 space-y-4 sm:space-y-5 bg-[#0a0a0a]/95">
